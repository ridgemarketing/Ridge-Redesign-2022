        ...
        <Container>
          ...
          <div className={visibility + ` lg:w-3/4`}>
            ...
            {content.intextFloatedImage &&
              <GatsbyImage className="mb-9 lg:mb-0 lg:w-1/5 lg:ml-[5%] mt-8 lg:mt-0" objectFit="contain" imgStyle="objectFit:contain" image={content.intextFloatedImage.localFile.childImageSharp.gatsbyImageData} alt={` `} />  
            }
          </Container>
        </Section>
