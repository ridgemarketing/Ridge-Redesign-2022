...
const OVERLAY = "linear-gradient(151.04deg, rgba(29,64,67,0.85) 24.09%, rgba(29,64,67,0.5) 62.33%, rgba(29,64,67,0.7) 88.78%)"
...
const HomeHero2026 = (props) => {
    ...
    let isImage = true;
    if (content.video) {
        var video = <video playsInline autoPlay="1" muted loop="loop" src={content.video} className={'absolute inset-0 object-cover object-center w-full h-full'} type="video/webm"></video>
        isImage = false;
    }
