            ...
            <Container classes={`flex flex-col gap-16`}>
                ...
                {stats && 
                    <motion.ul
                        ...
                        {stats.map((stat, key) => {
                            return (
                                <motion.li suppressHydrationWarning key={key} variants={variantItems}  className="flex flex-col w-full md:w-[calc(50%-24px)] xl:w-[calc(25%-24px)] gap-6 text-center font-stratos">
