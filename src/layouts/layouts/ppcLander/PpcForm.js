                ...
                <Container classes={`flex flex-col gap-[100px]`}>
                    <div className="flex flex-col-reverse items-center justify-center xl:flex-row xl:flex-wrap flex-nowrap xl:gap-6">
                        <div className="flex flex-col gap-6 text-left flex-1">
                            {heading &&
                                <h2 id="form" dangerouslySetInnerHTML={{__html: Parser(heading)}} className={`${cmo ? 'pt-8 md:pt-20' : 'pt-20'} text-center xl:text-left text-[2.5rem] leading-[2.7rem] md:text-[4.5rem] md:leading-[4.475rem] font-stratos font-semibold text-black uppercase`}></h2>
                            }
                            {body &&
                        ...
                        {image &&
                            ...
                            <img 
                                src         = {image.sourceUrl} 
                                alt         = {image.altText} 
                                className   = {`flex xl:self-start max-w-[250px] md:max-w-[459px] md:w-[459px] md:h-[459px] object-contain`} />
                        }
                    </div>
