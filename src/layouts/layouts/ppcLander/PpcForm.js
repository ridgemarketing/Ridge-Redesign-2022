                ...
                <Container classes={`flex flex-col gap-[100px]`}>
                    <div className="flex flex-nowrap gap-6 items-center">
                        <div className="flex flex-col gap-6 text-left flex-1">
                            {heading &&
                                <h2 dangerouslySetInnerHTML={{__html: Parser(heading)}} className={`text-[4.5rem] leading-[4.475rem] font-stratos font-semibold text-black uppercase`}></h2>
                            }
                            {body &&
                                <p dangerouslySetInnerHTML={{__html: Parser(body)}} className={`text-left ${theme.text.H4_LTE} text-rm-grey`}></p>
                            }
                        </div>
                        {image &&
                            <GatsbyImage 
                    ...
                    <div className="flex flex-col gap-4">
                        <h2 className={`${theme.text.H5} font-semibold text-black`}>Let's Talk</h2>
                        <FormLander2026 
                            classes             ={`w-full`} 
                            submitLabel         ={`Submit`} 
