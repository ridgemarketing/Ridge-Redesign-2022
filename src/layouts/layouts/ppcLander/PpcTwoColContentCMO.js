...
const PPCTwoColContentCMO = ({data}) => {
    ...
    return(<>
        <section className="pt-[60px] pb-[160px] relative">
            <Container classes={`flex flex-col xl:flex-row gap-8 flex-nowrap justify-center items-center xl:items-start xl:p-0 pb-20 xl:pb-20`}>
