                  ...
                  <div className="mt-12">
                    ...
                    >
                        {content.logos.map((logo, index) => {
                          if(logo.image.localFile){
                            const image = (logo.image.localFile.ext === ".svg") ? <img key={logo.image.sourceUrl} className={`w-full object-contain h-auto`} src={logo.image.sourceUrl} alt={logo.image.altText}/>
