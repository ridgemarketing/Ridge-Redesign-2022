              ...
              <div ref={firstSlide} className="flex flex-col ml-auto mr-auto w-[95%] md:flex-row md:w-full items-center sticky -translate-y-1/2 top-[50%]" style={ { height : slideHeight } }>
                  <div className="w-full h-full md:w-[50%] md:h-[80%] flex items-center" >
                      <div className="h-[100%] md:h-[70%]">
                        ...
                        <AnchorLink
                          to='#skipVerticalSlider'
                          title="Skip to the next section"
                          className={ `hidden md:flex transition-all ease-out ` + theme.text.H4_LTE + theme.text_links.BASE_STYLING + theme.text_links.FWD_BASE + theme.text_links.ARW_FWD_GREY + ` items-center text-rm-grey h-[30%] hover:text-rm-white capitalize`}
                        >
                        Skip
                        </AnchorLink>
                      </div>
                    ...
                    <AnchorLink
                          to='#skipVerticalSlider'
                          title="Skip to the next section"
                          className={ `md:hidden text-left w-full mt-[5%] h-[3%] transition-all ease-out ` + theme.text.H4_LTE + theme.text_links.BASE_STYLING + theme.text_links.FWD_BASE + theme.text_links.ARW_FWD_GREY  + ` flex items-center text-rm-grey hover:text-rm-white capitalize`}
                            >
                            Skip
                    </AnchorLink>
                </div>
